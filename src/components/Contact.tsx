    ...
    <section id="contact" className="border-t border-black/10">
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
        ...
        <div className="mt-12 flex flex-wrap gap-7">
          <a className="border-b border-black pb-2 text-sm font-semibold uppercase tracking-[0.14em]" href="https://www.linkedin.com/in/aakarsh-bommakanti/" target="_blank" rel="noreferrer">LinkedIn ↗</a>
