...
export function About() {
  return (
    <section id="about" className="mx-auto grid max-w-7xl gap-12 px-5 py-20 sm:px-6 sm:py-24 lg:grid-cols-[0.7fr_1.8fr] lg:px-10 lg:py-32">
      <div>
      ...
      <div>
        ...
        <p className="mt-8 max-w-3xl text-base leading-7 text-[var(--muted)] md:text-lg">
          I started in football writing and editing, moved into Microsoft’s Bing Sports team, then spent five years leading Hyderabad FC’s media operation before moving into global football publishing with FIFA Global Publishing around the FIFA World Cup. I’ve also scripted a two-season documentary series for Disney+ Hotstar and worked across live sports, sponsors and digital platforms.
        </p>
